...
function cleanNames(data) {
  ...
  return data.map(function (r) {
    var firstLetter = r.Player.charAt(0).toUpperCase();
    var restOfName = r.Player.slice(1).toLowerCase();
...
function getTopPlayers(data) {
  ...
  var sortedNames = Object.entries(nameCounts).sort(function (first, second) {
